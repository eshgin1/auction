<template>
  <section class="slider-section">
          ...
          <div class="slider-content">
            ...
            <div class="slider-price">
              <span class="slider-current"
                >{{ slide.currentPrice }} <small>₽</small></span
              >
              <span class="slider-time"
                ><i class="far fa-clock"></i> {{ slide.endTime }}</span
              >
            </div>
          </div>
    ...
    <div class="slider-controls">
      <button class="slider-btn" @click="prev">
        <i class="fas fa-arrow-left"></i>
      </button>
      <button class="slider-btn" @click="next">
        <i class="fas fa-arrow-right"></i>
      </button>
    </div>
    <div class="slider-dots">
      <span
        v-for="n in lotsForSlider.length"
        :key="n"
        class="dot"
